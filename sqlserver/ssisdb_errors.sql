...
where opr.object_name like '%gsf%'
...
where
	opr.object_name='PLXS.GSF.SSIS2016'
	and msg.message_type=120  /* Error */
	--and msg.message_type in (110,120)  /* Warning, Error */
	--and msg.message_time>dateadd(minute,-15,getdate())
	--and msg.message_time>dateadd(day,-1,getdate())
	and msg.message_time>='2023-10-24 19:50:00.0000000 -05:00'
	and msg.message_time<='2023-10-24 19:54:00.0000000 -05:00'
order by
	message_time;
