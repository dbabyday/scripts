/*
GSF PD gcc-sql-pd-007	Gsfdistribution_PROD
GSF QA co-db-957	Distribution
MAX gcc-sql-pd-007	Distribution
*/



USE Gsfdistribution_PROD -- distribution or Gsfdistribution_PROD
Go
...
select   a.name distribution_agent_name
       , a.publisher_db
	   , a.publication
	   , a.subscriber_db
	   , h.time
	   , h.delivery_latency/1000 delivery_latency_seconds 
from     MSdistribution_history h
join     MSdistribution_agents  a on a.id=h.agent_id
--where    h.delivery_latency>60000
--         and h.time>'2021-09-29 20:00' 
--         and h.time<'2021-09-30 02:00'
order by h.time
       , h.agent_id;
