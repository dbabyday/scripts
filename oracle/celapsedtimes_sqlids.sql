...
create table ca.elapsedtimes_sqlids (sql_id varchar2(13));



delete from ca.elapsedtimes_sqlids;
insert all
	into ca.elapsedtimes_sqlids (sql_id) values ('64bj9s19jdx9g')
	into ca.elapsedtimes_sqlids (sql_id) values ('1znjwwtbtd2sg')
	into ca.elapsedtimes_sqlids (sql_id) values ('cxhxadfqzu8jp')
	into ca.elapsedtimes_sqlids (sql_id) values ('3nwut11c1an8w')
	into ca.elapsedtimes_sqlids (sql_id) values ('b18wh4xqm92h1')
	into ca.elapsedtimes_sqlids (sql_id) values ('dg80sc25h2g82')
	into ca.elapsedtimes_sqlids (sql_id) values ('42710qy219g0r')
