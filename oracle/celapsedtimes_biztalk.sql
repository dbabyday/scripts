...
BEGIN
	...
	where    px_servers_executions=0
	         and (     upper(sql_text) like '%F554708%'
	                or upper(sql_text) like '%F554709%'
	                or upper(sql_text) like '%F5547033%'
	                or upper(sql_text) like '%F5542009%'
	                or upper(sql_text) like '%F5542222%'
	                or upper(sql_text) like '%F5542040%'
	                or upper(sql_text) like '%F5541044%'
	                or upper(sql_text) like '%F5542223%'
	             )
