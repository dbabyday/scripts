rem  Copyright 1997-2013, DBConnect Solutions, Inc.  All Rights Reserved.
rem  NightOwl® and the NightOwl® logo are trademarks of 
rem  DBConnect Solutions, Inc.
rem
rem  Authorized users are granted permission to use the software contained
rem  herein only under strict adherence to the terms of the license agreement 
rem  found at: http:/www.dbconnect.com/license
rem
rem  The license agreement is also available by contacting:
rem
rem  DBConnect Solutions, Inc.
rem  www.dbconnect.com
rem  1-877-325-9985
rem  ---------------------------------------------------------------------------

rem  ---------------------------------------------------------------------------
rem  owl_wait_details.sql
rem  
...
rem
rem  Modifications:	Updated for version 8.x, 9.x, 9i, 10g, and 11g
rem
...
rem
spool \\neen-dsk-011\it$\database\users\James\JamesDownloads\troubleshootJDE_wait_details_ubes.txt


prompt © 1997-2013 DBConnect Solutions, Inc., Fort Wayne, IN (877) 325-9985. All Rights Reserved.
