...
BEGIN
	...
	dbms_sqltune.execute_tuning_task(task_name => 'JamesTuningTask_&&sql_id');
END;
/

-- display the report
select dbms_sqltune.report_tuning_task('JamesTuningTask_&&sql_id') line from dual;
...
execute dbms_output.put_line('execute dbms_sqltune.drop_tuning_task(''JamesTuningTask_&&sql_id'');');
execute dbms_output.put_line(chr(10));
