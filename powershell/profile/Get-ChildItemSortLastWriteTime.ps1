...
"------   -------------------   -------   ----------------------------"
Get-ChildItem | Where-Object { $_.Attributes -eq "Directory" } | Sort-Object LastWriteTime | ForEach-Object {
...
Get-ChildItem | Where-Object { $_.Attributes -ne "Directory" } | Sort-Object LastWriteTime | ForEach-Object {
	if ($_.Length -ge 1TB) {
